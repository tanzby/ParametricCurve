...
class BezierFittingDemo {
  ...
  void static onMouseCallback(int event, int x, int y, int flags,
                              void *userdata) {
...
public:
  void run() {
    ...
    createTrackbar("max_error", window_name, &max_error, 5000,
                   &BezierFittingDemo::onTrackerCallback, this);
