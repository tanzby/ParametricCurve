...
struct NumericalQuadrature {
  template <typename F>
  static auto simpson_1_3(F &&derivative_func, const double &L,
  ...
  template <typename F>
  static auto adaptive_simpson_1_3(F &&derivative_func, const double &L,
                                     const double &R,
  ...
  template <typename F>
  static auto simpson_3_8(F &&derivative_func, const double &L,
                            const double &R) -> double {
  ...
  template <typename F>
  static auto adaptive_simpson_3_8(F &&derivative_func, const double &L,
                                     const double &R,
                                     const double &eps = 0.0001) -> double {
    const double mid = (L + R) / 2.0;
